...
<head>
    ...
    <title>Jubilut - Lista de Áreas</title>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-links">
                            <a href="/?url=area/edit&id=<?= $area['id'] ?>" class="btn-edit">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <a href="/?url=area/delete&id=<?= $area['id'] ?>" onclick="return confirm('Tem certeza que deseja excluir esta área?')" class="btn-delete">
